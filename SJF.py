...
def sjf(processes):
    ...
    while completed_processes < n:
        ...
        if ready_processes:
            ...
            current_process = min(ready_processes, key=lambda x: x['burst_time'])
...
print("Shortest Job First (SJF) Scheduling Algorithm")
...
# Call the SJF function to calculate the scheduling details
if processes:  # Only run if processes were successfully loaded
    avg_waiting_time, avg_turnaround_time, avg_completion_time = sjf(processes)

    # Print the process details after the SJF function has been executed
